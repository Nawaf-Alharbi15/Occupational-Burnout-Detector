 export const q = [
  // Section 1: Emotional Exhaustion "Exhaustion"
  { id: 1, category: "exhaustion", text: "I feel emotionally drained because of my work." },
  { id: 2, category: "exhaustion", text: "I feel that my work requires too much energy." },
  { id: 3, category: "exhaustion", text: "i'm finding that working with people directly stressful." },
  { id: 4, category: "exhaustion", text: "I feel Im overworking at my job" },
  { id: 5, category: "exhaustion", text: "I feel like Ive reached my absolute limit." },

  // Section 2: Personal Accomplishment "performance"
  { id: 6, category: "performance", text: "I feel Im making a positive impact on other peoples lives through my work." },
